...
export default function ResumenProducto ({ producto }) {
  ...
  return (
    <div className='shadow p-5 flex gap-10 items-center'>
      ...
      <div>
        <button onClick={() => handleEditarCantidad(producto.id)} type='button' className='bg-sky-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full justify-center'>
